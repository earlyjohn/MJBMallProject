...
$$('#editCart').on('click', function () {
    window.location.href = "edit-cart.html";
});
$$('#positon').on('click', function () {
    window.location.href = "position.html";
});
$$('#classfy').on('click', function () {
    window.location.href = "classfy.html";
});
$$('#editClassfy').on('click', function () {
    window.location.href = "editClassfy.html";
});
$$('.hangyefenlei').on('click', function () {
    window.location.href = "hangyefenlei.html";
});
$$('.more').on('click', function () {
    window.location.href = "classfy.html";
});
$$('#dianpujiemian').on('click', function () {
    window.location.href = "dianpujiemian.html";
});
$$('.secondClassfy').on('click', function () {
    window.location.href = "productsList.html";
});
$$('#secondClassfyBack').on('click', function () {
    history.go(-1);
});
$$('#firstClassfyBack').on('click', function () {
    history.go(-1);
});

$$('#firstClassfyBack1').on('click', function () {
    window.location.href = "home.html";
});
...
$$('#shenbianHref').on('click', function () {
    window.location.href = "shenbian.html";
});
$$('#productDetailBack').on('click', function () {
    history.go(-1);
});
...
$$('#oneClassfy').on('click', function () {
    window.location.href = "firstCLassfy.html";
});
$$('.oneClassfy').on('click', function () {
    window.location.href = "firstCLassfy.html";
});
...
$$('#xianshi').on('click', function () {
    window.location.href = "xianshihuodong.html";
});
//商品弹出层
$$('.open-product').on('click', function () {
  myApp.popup('.popup-product');
   	$$('div.navbar').addClass('navbar-hidden');
    $$('div.page-content').addClass('resetPadding');
});
var context = {};
...
$$('#addrInput').on('click', function (e) {
    ...
    var pickerDependent = myApp.picker({
        ...
        cols: [
            {
                textAlign: 'left',
                values: ["北京市","上海市","广东省","安徽省","重庆市","福建省","甘肃省","广西区","贵州省","海南省","河北省","河南省","黑龙江省","湖北省", "湖南省", "吉林省", "江苏省", "江西省","辽宁省","内蒙古区","宁夏区","青海省","山东省","山西省","山东省","陕西省","四川省","天津市", "西藏区","新疆区","云南省","浙江省" ],
