		    ...
		    toolbarTemplate: 
		        '<div class="toolbar">' +
		            '<div class="toolbar-inner">' +
		                '<div class="left">' +
		                    '<a href="#" class="link toolbar-randomize-link">省/市</a>' +
		                '</div>' +
		                '<div class="right">' +
		                    '<a href="#" class="link close-picker">区</a>' +
		                '</div>' +
		            '</div>' +
		        '</div>',
		    cols: [
		        ...
		        {
		            textAlign: 'left',
		            values: ('东城区  西城区  城市功能拓展区  海淀区  朝阳区   丰台区   石景山区    城市发展新区  通州区  顺义区   房山区   大兴区  昌平区').split(' ')
		        },
		        {
		            values: ('北辰区 西青区 红桥区 河东区 Girl Person Cutie Babe Raccoon').split(' ')
		        },
		    ],
